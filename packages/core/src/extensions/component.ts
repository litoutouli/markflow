...
export const BUILT_IN_COMPONENTS: CustomComponentDef[] = [
  ...
  <p style="text-align: center; font-size: 14px; color: #888; margin-top: 8px; margin-bottom: 0;">{{text}}</p>
    ...
    example: `<QRCodeBlock url="https://github.com/litoutouli/markflow" text="扫码访问" size="150" />`,
  },
  {
    id: `builtin-card`,
    name: `CardBlock`,
  ...
  <section style="padding: 16px;">
    ...
    example: `<CardBlock title="MarkFlow" description="Markdown 内容排版工作台" url="https://github.com/litoutouli/markflow" />`,
  },
  {
    id: `builtin-author`,
    name: `AuthorBlock`,
  ...
  <section style="display: table-cell; vertical-align: middle; padding-left: 12px;">
    ...
    example: `<AuthorBlock name="litoutouli" avatar="https://github.com/litoutouli.png" bio="MarkFlow creator" />`,
  },
  {
    id: `builtin-tip`,
    name: `TipBlock`,
