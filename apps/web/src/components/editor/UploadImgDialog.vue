              ...
              <Field v-slot="{ field, errorMessage }" name="accessKeySecret">
                <FormItem label="AccessKey Secret" required :error="errorMessage">
                  <Input
                    ...
                    v-model="field.value"
                    type="password"
                    placeholder="如：cc1d0c142example0902bd2d7markflow4b14da6"
                  />
                </FormItem>
              </Field>
              ...
              <Field v-slot="{ field, errorMessage }" name="bucket">
                <FormItem label="Bucket" required :error="errorMessage">
                  <Input
                    v-bind="field"
                    v-model="field.value"
                    placeholder="如：markflow-3212520134"
                  />
                </FormItem>
              </Field>
              ...
              <Field v-slot="{ field, errorMessage }" name="accessKey">
                <FormItem label="AccessKey" required :error="errorMessage">
                  <Input
                    v-bind="field"
                    v-model="field.value"
                    placeholder="如：6DD3VaLJ_SQgOexampleTV_YWaDmarkflow"
                  />
                </FormItem>
              </Field>
              ...
              <FormItem>
                <div class="flex flex-col items-start">
                  ...
                  <Button
                    ...
                    class="p-0 h-auto text-left whitespace-normal"
                    as="a"
                    href="https://github.com/litoutouli/markflow"
                    target="_blank"
                  >
                    如何配置公众号图床？
                  </Button>
